getgenv().VO_CONFIG = {
    ...
    PetFarmList = {"River Otter", "Ruddy Duck", "Stygian Owl"}, -- Ordered pet names: age all non-FG of first name, then second, etc.; fallback if none available
    ...
    -- === AGE PETS ===
    AgePets = true,
    AgePetsNames = {"River Otter", "Ruddy Duck", "Forest Sprite", "Stygian Owl"},
