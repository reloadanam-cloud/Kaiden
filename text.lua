getgenv().VO_CONFIG = {
    ...
    PetFarmList = {"Alicorn", "Ancient Dragon", "Dragonfly", "Unicorn Ducky", "Purrowl"}, -- Ordered pet names: age all non-FG of first name, then second, etc.; fallback if none available
    ...
    -- === AGE PETS ===
    AgePets = true,
    AgePetsNames = {"Alicorn", "Ancient Dragon", "Dragonfly", "Unicorn Ducky", "Purrowl"},
